    ...
    window.addEventListener('message', function(event) {
        ...
        outputImage.onload = async function() {
            ...
            if (outputImage !== null) {
                ...
                var teamMemberId = "1";  // The ID of the team member you're interested in
                var className = "Class 1";  // The name of the class you're interested in

                var confidence = teamMemberPredictions[teamMemberId][className];  // The confidence of this team member for this class
